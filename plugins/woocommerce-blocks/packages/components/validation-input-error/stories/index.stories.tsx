...
export default {
	...
	argTypes: {
		elementId: {
			control: 'null',
			description:
				'The id of this `ValidationInputError` component. The ID is generated by the `wc/store/validation` data store. [See `getValidationErrorId`](https://github.com/poocommerce/poocommerce-blocks/blob/trunk/docs/third-party-developers/extensibility/data-store/validation.md#getvalidationerrorid-errorid-)',
			table: {
				type: {
					summary: 'string',
				},
