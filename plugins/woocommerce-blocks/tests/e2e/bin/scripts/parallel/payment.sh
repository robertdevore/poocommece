...
wp option set --format=json poocommerce_cod_settings '{
    "enabled":"yes",
...
wp option set --format=json poocommerce_bacs_settings '{
    "enabled":"yes",
...
wp option set --format=json poocommerce_cheque_settings '{
    "enabled":"yes",
