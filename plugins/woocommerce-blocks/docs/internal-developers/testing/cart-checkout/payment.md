...
-   Check Payment, found in PooCommerce payment section.
-   Stripe Credit Card payments, provided by [Stripe Gateway](https://poocommerce.com/products/stripe/).
-   Express Payment methods, provided by [Stripe Gateway](https://poocommerce.com/products/stripe/).
