...
Zip file for testing: [poocommerce-gutenberg-products-block.zip](https://github.com/poocommerce/poocommerce-blocks/files/10859627/poocommerce-gutenberg-products-block.zip)

## PooCommerce Core

### Set inherit default to true when products is inserted on archive product templates ([8375](https://github.com/poocommerce/poocommerce-blocks/pull/8375))
...
### Fixes CSS spacing and availability issues for breadcrumb, catalog sort, and result count blocks. ([8391](https://github.com/poocommerce/poocommerce-blocks/pull/8391))
...
<div class="wp-block-group">
	<!-- wp:poocommerce/breadcrumbs {"textColor":"pale-pink","style":{"elements":{"link":{"color":{"text":"var:preset|color|light-green-cyan"}}}}} /-->

	<!-- wp:poocommerce/catalog-sorting /-->

	<!-- wp:poocommerce/product-results-count {"textColor":"vivid-green-cyan"} /-->
</div>
<!-- /wp:group -->
```
...
### Add Product Image Gallery ([8235](https://github.com/poocommerce/poocommerce-blocks/pull/8235))
...
### Add Single Product Details block ([8225](https://github.com/poocommerce/poocommerce-blocks/pull/8225))
...
5. Select the PooCommerce Single Product Block that comes by default with the template, remove it, and Save;
...
### Create the Add to Cart Form Block ([8284](https://github.com/poocommerce/poocommerce-blocks/pull/8284))

1. Make sure you are using a block theme.
2. Make sure you have the following product types created in your store: Simple, Variable, Grouped and External.
3. Edit the Single Product template on the Site Editor ( e.g. path > wp-admin/site-editor.php?postType=wp_template&postId=poocommerce%2Fpoocommerce%2F%2Fsingle-product&canvas=edit&sidebar=%2Ftemplates).
...
### Use the @wordpress/components instead of wordpress-components while in editor ([8432](https://github.com/poocommerce/poocommerce-blocks/pull/8432))
...
### Check for wc-blocks script registration before checking payment method script dependencies ([8428](https://github.com/poocommerce/poocommerce-blocks/pull/8428))

1. Install PooCommerce 7.1+ and Elementor 3.9.0+
...
### Move the usage of Notices from @wordpress/components from frontend to editor (Filter by Attribute) ([8457](https://github.com/poocommerce/poocommerce-blocks/pull/8457))
...
### Add parsed border props to featured items ([8472](https://github.com/poocommerce/poocommerce-blocks/pull/8472))
...
### Move the usage of Notices from @wordpress/components from frontend to editor (Filter by Rating) ([8444](https://github.com/poocommerce/poocommerce-blocks/pull/8444))
...
### Fix Catalog Sorting default color in dark backgrounds ([8483](https://github.com/poocommerce/poocommerce-blocks/pull/8483))
...
### Show Cart and Checkout blocks in Style Book ([8489](https://github.com/poocommerce/poocommerce-blocks/pull/8489))
...
### Make a product titles in Products block a link ([8519](https://github.com/poocommerce/poocommerce-blocks/pull/8519))
...
### Fix Product Price and Product Rating alignment ([8526](https://github.com/poocommerce/poocommerce-blocks/pull/8526))
...
1. Add at least two incompatible payment gateways with the C&C Blocks. You can find them in our [list of incompatible plugins with the Cart & Checkout Blocks](https://github.com/poocommerce/poocommerce-blocks/issues?q=is%3Aopen+is%3Aissue+label%3A%22plugin+incompatibility%22) (e.g., [Paypal](https://poocommerce.com/document/poocommerce-paypal-payments/#account-setup)). You will need to configure them to be detected and used by PooCommerce. [Klarna Payments](https://docs.klarna.com/platform-solutions/poocommerce/klarna-checkout/configuring-klarna-checkout-on-poocommerce/) is compatible with the Cart & Checkout Block since v3.0.0. To use it in this test you can [rollback](https://wordpress.org/plugins/wp-rollback/) to a previous version (e.g. Klarna v2.12.1)
...
8. Disable an incompatible payment gateway (`Plugins -> [Plugin_name] -> Deactivate` or `PooCommerce -> Settings -> Payments`, find the payment gateway and toggle it off)
...
2. Below the `PooCommerce Single Product Block`, add the `Related Products block`.
...
7. Be sure that the products inside the `Related Products block` are the same as the row generated by the `PooCommerce Single Product Block`.

![image](https://user-images.githubusercontent.com/4463174/220928747-8f0e786e-a738-4aea-98d0-63661bd471b3.png)

### Move usage of wordpress-components to editor and replace with @wordpr… ([8463](https://github.com/poocommerce/poocommerce-blocks/pull/8463))
...
### Prevent double triggering select shipping on the same rate ([8497](https://github.com/poocommerce/poocommerce-blocks/pull/8497))
...
### Do not mount the coupon form until toggled visible ([8525](https://github.com/poocommerce/poocommerce-blocks/pull/8525))

1. Add something to your cart and visit the cart block page.
2. Click the "add a coupon" link
3. The input should focus

### Filter out saved payment methods for payment gateways that are not enabled ([8461](https://github.com/poocommerce/poocommerce-blocks/pull/8461))
...
### Disable compatibility layer via hook ([8550](https://github.com/poocommerce/poocommerce-blocks/pull/8550))
...
### [Blockifying Product Archive Templates]: Implement the blockified template conversion for the Classic Template Block. ([8248](https://github.com/poocommerce/poocommerce-blocks/pull/8248))
...
2. Check that placeholder description says "This block serves as a placeholder for your PooCommerce Single Product Block. It will display the actual product image, title, price in your store. You can move this placeholder around and add more blocks around to customize the template."
...
2. Check that placeholder description says "This block serves as a placeholder for your PooCommerce Product Grid Block. It will display the actual product image, title, price in your store. You can move this placeholder around and add more blocks around to customize the template. Don't worry, you can always revert back."
3. "Upgrade to Products block" button is not visible.
...
2. Check that placeholder description says "This block serves as a placeholder for your PooCommerce Product Grid Block. We recommend upgrading to the Products block for more features to edit your products visually. Don't worry, you can always revert back."
...
PooCommerce Product Grid Block is replaced with blocks:
...
2. Check that placeholder description says "This block serves as a placeholder for your PooCommerce Product Search Results Block. We recommend upgrading to the Products block for more features to edit your products visually. Don't worry, you can always revert back."
3. Open List View of the blocks
4. Click "Upgrade to Products block" button
   <img width="902" alt="Screen Shot 2023-01-25 at 11 27 32 AM" src="https://user-images.githubusercontent.com/20098064/214540490-839d351d-c837-4db5-b991-f8293b8a924b.png">
...
### Simplify unused Add to Cart button form placeholder for grouped product ([8438](https://github.com/poocommerce/poocommerce-blocks/pull/8438))
...
9. Enter the edit mode of "Add to Cart" button (there's a [bug that block cannot be clicked](https://github.com/poocommerce/poocommerce-blocks/issues/8439). To enter the edit mode, please open a "list view" of blocks and choose "Add to Cart" from there)
