...
class WC_REST_WCCOM_Site_Installer_Error_Codes {
	...
	const ERROR_MESSAGES = array(
		...
		self::SITE_NOT_CONNECTED                 => 'Site not connected to PooCommerce.com',
		...
		self::FAILED_GETTING_PRODUCT_INFO        => 'Failed to retrieve product info from PooCommerce.com',
		self::INVALID_PRODUCT_INFO_RESPONSE      => 'Invalid product info response from PooCommerce.com',
