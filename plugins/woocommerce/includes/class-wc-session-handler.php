 ...
 *
 * From 2.5 this uses a custom table for session storage. Based on https://github.com/kloon/poocommerce-large-sessions.
 *
...
class WC_Session_Handler extends WC_Session {
	...
	public function __construct() {
		$this->_cookie = apply_filters( 'poocommerce_cookie', 'wp_poocommerce_session_' . COOKIEHASH );
		$this->_table  = $GLOBALS['wpdb']->prefix . 'poocommerce_sessions';
	}
	...
	public function init() {
		...
		add_action( 'poocommerce_set_cart_cookies', array( $this, 'set_customer_session_cookie' ), 10 );
	...
	public function init_session_cookie() {
		...
		if ( $cookie ) {
			...
			if ( is_user_logged_in() && strval( get_current_user_id() ) !== $this->_customer_id ) {
				 ...
				 */
				do_action( 'poocommerce_guest_session_to_user_id', $guest_session_id, $this->_customer_id );
			}
	...
	public function maybe_update_nonce_user_logged_out( $uid, $action ) {
		if ( Automattic\PooCommerce\Utilities\StringUtil::starts_with( $action, 'poocommerce' ) ) {
			return $this->has_session() && $this->_customer_id ? $this->_customer_id : $uid;
		}
