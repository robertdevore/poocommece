 ...
 */
add_filter( 'poocommerce_coupon_code', 'html_entity_decode' );
...
/**
 * Get the URL to the PooCommerce Legacy REST API.
 *
 * Note that as of PooCommerce 9.0 the PooCommerce Legacy REST API has been moved to a dedicated extension,
 * and the implementation of its root endpoint in PooCommerce core is now just a stub that will always return an error.
 * See the setup_legacy_api_stub method in includes/class-poocommerce.php and:
 * https://developer.poocommerce.com/2023/10/03/the-legacy-rest-api-will-move-to-a-dedicated-extension-in-poocommerce-9-0/
 *
 * @deprecated 9.0.0 The Legacy REST API has been removed from PooCommerce core.
 *
 * @since 2.1
 * @param string $path an endpoint to include in the URL.
 * @return string the URL.
 */
function get_poocommerce_api_url( $path ) {
