 ...
 * @param string $version     The version of PooCommerce that deprecated the hook.
...
function wc_caught_exception( $exception_object, $function = '', $args = array() ) {
	...
	do_action( 'poocommerce_caught_exception', $exception_object, $function, $args );
 ...
 * @deprecated 2.1
 */
function poocommerce_show_messages() {
	wc_deprecated_function( 'poocommerce_show_messages', '2.1', 'wc_print_notices' );
	wc_print_notices();
}
 ...
 * @deprecated 2.1
 */
function poocommerce_weekend_area_js() {
	wc_deprecated_function( 'poocommerce_weekend_area_js', '2.1' );
}

/**
 * @deprecated 2.1
 */
function poocommerce_tooltip_js() {
	wc_deprecated_function( 'poocommerce_tooltip_js', '2.1' );
}

/**
 * @deprecated 2.1
 */
function poocommerce_datepicker_js() {
	wc_deprecated_function( 'poocommerce_datepicker_js', '2.1' );
}

/**
 * @deprecated 2.1
 */
function poocommerce_admin_scripts() {
	wc_deprecated_function( 'poocommerce_admin_scripts', '2.1' );
}

/**
 * @deprecated 2.1
 */
function poocommerce_create_page( $slug, $option = '', $page_title = '', $page_content = '', $post_parent = 0 ) {
	wc_deprecated_function( 'poocommerce_create_page', '2.1', 'wc_create_page' );
 ...
 * @deprecated 2.1
 */
function poocommerce_readfile_chunked( $file, $retbytes = true ) {
	wc_deprecated_function( 'poocommerce_readfile_chunked', '2.1', 'WC_Download_Handler::readfile_chunked()' );
 ...
 * @return string
 */
function poocommerce_format_total( $number ) {
 ...
 * @return string
 */
function poocommerce_get_formatted_product_name( $product ) {
 ...
 * @access public
 */
function poocommerce_legacy_paypal_ipn() {
	if ( ! empty( $_GET['paypalListener'] ) && 'paypal_standard_IPN' === $_GET['paypalListener'] ) {
		WC()->payment_gateways();
		do_action( 'poocommerce_api_wc_gateway_paypal' );
	}
}
add_action( 'init', 'poocommerce_legacy_paypal_ipn' );
 ...
 * @deprecated 3.0
 */
function poocommerce_protected_product_add_to_cart( $passed, $product_id ) {
 ...
 * @deprecated 3.0
 */
function poocommerce_empty_cart() {
 ...
 * @deprecated 3.0
 */
function poocommerce_load_persistent_cart( $user_login, $user = 0 ) {
 ...
 * @deprecated 3.0
 */
function poocommerce_add_to_cart_message( $product_id ) {
 ...
 * @deprecated 3.0
 */
function poocommerce_clear_cart_after_payment() {
 ...
 * @deprecated 3.0
 */
function poocommerce_cart_totals_subtotal_html() {
 ...
 * @deprecated 3.0
 */
function poocommerce_cart_totals_shipping_html() {
 ...
 * @deprecated 3.0
 */
function poocommerce_cart_totals_coupon_html( $coupon ) {
 ...
 * @deprecated 3.0
 */
function poocommerce_cart_totals_order_total_html() {
 ...
 * @deprecated 3.0
 */
function poocommerce_cart_totals_fee_html( $fee ) {
 ...
 * @deprecated 3.0
 */
function poocommerce_cart_totals_shipping_method_label( $method ) {
 ...
 * @deprecated 3.0
 */
function poocommerce_get_template_part( $slug, $name = '' ) {
 ...
 * @deprecated 3.0
 */
function poocommerce_get_template( $template_name, $args = array(), $template_path = '', $default_path = '' ) {
 ...
 * @deprecated 3.0
 */
function poocommerce_locate_template( $template_name, $template_path = '', $default_path = '' ) {
 ...
 * @deprecated 3.0
 */
function poocommerce_mail( $to, $subject, $message, $headers = "Content-Type: text/html\r\n", $attachments = "" ) {
 ...
 * @deprecated 3.0
 */
function poocommerce_disable_admin_bar( $show_admin_bar ) {
 ...
 * @deprecated 3.0
 */
function poocommerce_create_new_customer( $email, $username = '', $password = '' ) {
 ...
 * @deprecated 3.0
 */
function poocommerce_set_customer_auth_cookie( $customer_id ) {
 ...
 * @deprecated 3.0
 */
function poocommerce_update_new_customer_past_orders( $customer_id ) {
 ...
 * @deprecated 3.0
 */
function poocommerce_paying_customer( $order_id ) {
 ...
 * @deprecated 3.0
 */
function poocommerce_customer_bought_product( $customer_email, $user_id, $product_id ) {
 ...
 * @deprecated 3.0
 */
function poocommerce_customer_has_capability( $allcaps, $caps, $args ) {
 ...
 * @deprecated 3.0
 */
function poocommerce_sanitize_taxonomy_name( $taxonomy ) {
 ...
 * @deprecated 3.0
 */
function poocommerce_get_filename_from_url( $file_url ) {
 ...
 * @deprecated 3.0
 */
function poocommerce_get_dimension( $dim, $to_unit ) {
 ...
 * @deprecated 3.0
 */
function poocommerce_get_weight( $weight, $to_unit ) {
 ...
 * @deprecated 3.0
 */
function poocommerce_trim_zeros( $price ) {
 ...
 * @deprecated 3.0
 */
function poocommerce_round_tax_total( $tax ) {
 ...
 * @deprecated 3.0
 */
function poocommerce_format_decimal( $number, $dp = false, $trim_zeros = false ) {
 ...
 * @deprecated 3.0
 */
function poocommerce_clean( $var ) {
 ...
 * @deprecated 3.0
 */
function poocommerce_array_overlay( $a1, $a2 ) {
 ...
 * @deprecated 3.0
 */
function poocommerce_price( $price, $args = array() ) {
 ...
 * @deprecated 3.0
 */
function poocommerce_let_to_num( $size ) {
 ...
 * @deprecated 3.0
 */
function poocommerce_date_format() {
 ...
 * @deprecated 3.0
 */
function poocommerce_time_format() {
 ...
 * @deprecated 3.0
 */
function poocommerce_timezone_string() {
	wc_deprecated_function( __FUNCTION__, '3.0', 'wc_timezone_string' );
	return wc_timezone_string();
}

if ( ! function_exists( 'poocommerce_rgb_from_hex' ) ) {
	/**
	 * @deprecated 3.0
	 */
	function poocommerce_rgb_from_hex( $color ) {
		wc_deprecated_function( __FUNCTION__, '3.0', 'wc_rgb_from_hex' );
		return wc_rgb_from_hex( $color );
	}
}

if ( ! function_exists( 'poocommerce_hex_darker' ) ) {
	/**
	 * @deprecated 3.0
	 */
	function poocommerce_hex_darker( $color, $factor = 30 ) {
		wc_deprecated_function( __FUNCTION__, '3.0', 'wc_hex_darker' );
		return wc_hex_darker( $color, $factor );
	}
}

if ( ! function_exists( 'poocommerce_hex_lighter' ) ) {
	/**
	 * @deprecated 3.0
	 */
	function poocommerce_hex_lighter( $color, $factor = 30 ) {
		wc_deprecated_function( __FUNCTION__, '3.0', 'wc_hex_lighter' );
		return wc_hex_lighter( $color, $factor );
	}
}

if ( ! function_exists( 'poocommerce_light_or_dark' ) ) {
	/**
	 * @deprecated 3.0
	 */
	function poocommerce_light_or_dark( $color, $dark = '#000000', $light = '#FFFFFF' ) {
		wc_deprecated_function( __FUNCTION__, '3.0', 'wc_light_or_dark' );
		return wc_light_or_dark( $color, $dark, $light );
	}
}

if ( ! function_exists( 'poocommerce_format_hex' ) ) {
	/**
	 * @deprecated 3.0
	 */
	function poocommerce_format_hex( $hex ) {
 ...
 * @deprecated 3.0
 */
function poocommerce_get_order_id_by_order_key( $order_key ) {
 ...
 * @deprecated 3.0
 */
function poocommerce_downloadable_file_permission( $download_id, $product_id, $order ) {
 ...
 * @deprecated 3.0
 */
function poocommerce_downloadable_product_permissions( $order_id ) {
 ...
 * @deprecated 3.0
 */
function poocommerce_add_order_item( $order_id, $item ) {
 ...
 * @deprecated 3.0
 */
function poocommerce_delete_order_item( $item_id ) {
 ...
 * @deprecated 3.0
 */
function poocommerce_update_order_item_meta( $item_id, $meta_key, $meta_value, $prev_value = '' ) {
 ...
 * @deprecated 3.0
 */
function poocommerce_add_order_item_meta( $item_id, $meta_key, $meta_value, $unique = false ) {
 ...
 * @deprecated 3.0
 */
function poocommerce_delete_order_item_meta( $item_id, $meta_key, $meta_value = '', $delete_all = false ) {
 ...
 * @deprecated 3.0
 */
function poocommerce_get_order_item_meta( $item_id, $key, $single = true ) {
 ...
 * @deprecated 3.0
 */
function poocommerce_cancel_unpaid_orders() {
 ...
 * @deprecated 3.0
 */
function poocommerce_processing_order_count() {
 ...
 * @deprecated 3.0
 */
function poocommerce_get_page_id( $page ) {
 ...
 * @deprecated 3.0
 */
function poocommerce_get_endpoint_url( $endpoint, $value = '', $permalink = '' ) {
 ...
 * @deprecated 3.0
 */
function poocommerce_lostpassword_url( $url ) {
 ...
 * @deprecated 3.0
 */
function poocommerce_customer_edit_account_url() {
 ...
 * @deprecated 3.0
 */
function poocommerce_nav_menu_items( $items, $args ) {
 ...
 * @deprecated 3.0
 */
function poocommerce_nav_menu_item_classes( $menu_items, $args ) {
 ...
 * @deprecated 3.0
 */
function poocommerce_list_pages( $pages ) {
 ...
 * @deprecated 3.0
 */
function poocommerce_product_dropdown_categories( $args = array(), $deprecated_hierarchical = 1, $deprecated_show_uncategorized = 1, $deprecated_orderby = '' ) {
 ...
 * @deprecated 3.0
 */
function poocommerce_walk_category_dropdown_tree( $a1 = '', $a2 = '', $a3 = '' ) {
 ...
 * @deprecated 3.0
 */
function poocommerce_taxonomy_metadata_wpdbfix() {
 ...
 * @deprecated 3.0
 */
function poocommerce_order_terms( $the_term, $next_id, $taxonomy, $index = 0, $terms = null ) {
 ...
 * @deprecated 3.0
 */
function poocommerce_set_term_order( $term_id, $index, $taxonomy, $recursive = false ) {
 ...
 * @deprecated 3.0
 */
function poocommerce_terms_clauses( $clauses, $taxonomies, $args ) {
 ...
 * @deprecated 3.0
 */
function _poocommerce_term_recount( $terms, $taxonomy, $callback, $terms_are_term_taxonomy_ids ) {
 ...
 * @deprecated 3.0
 */
function poocommerce_recount_after_stock_change( $product_id ) {
 ...
 * @deprecated 3.0
 */
function poocommerce_change_term_counts( $terms, $taxonomies, $args ) {
 ...
 * @deprecated 3.0
 */
function poocommerce_get_product_ids_on_sale() {
 ...
 * @deprecated 3.0
 */
function poocommerce_get_featured_product_ids() {
 ...
 * @deprecated 3.0
 */
function poocommerce_get_product_terms( $object_id, $taxonomy, $fields = 'all' ) {
 ...
 * @deprecated 3.0
 */
function poocommerce_product_post_type_link( $permalink, $post ) {
 ...
 * @deprecated 3.0
 */
function poocommerce_placeholder_img_src() {
 ...
 * @deprecated 3.0
 */
function poocommerce_placeholder_img( $size = 'poocommerce_thumbnail' ) {
 ...
 * @deprecated 3.0
 */
function poocommerce_get_formatted_variation( $variation = '', $flat = false ) {
 ...
 * @deprecated 3.0
 */
function poocommerce_scheduled_sales() {
 ...
 * @deprecated 3.0
 */
function poocommerce_get_attachment_image_attributes( $attr ) {
 ...
 * @deprecated 3.0
 */
function poocommerce_prepare_attachment_for_js( $response ) {
 ...
 * @deprecated 3.0
 */
function poocommerce_track_product_view() {
 ...
 */
function poocommerce_compile_less_styles() {
	wc_deprecated_function( 'poocommerce_compile_less_styles', '2.3' );
}

/**
 * poocommerce_calc_shipping was an option used to determine if shipping was enabled prior to version 2.6.0. This has since been replaced with wc_shipping_enabled() function and
 * the poocommerce_ship_to_countries setting.
 * @deprecated 2.6.0
 * @return string
 */
function poocommerce_calc_shipping_backwards_compatibility( $value ) {
	if ( Constants::is_defined( 'WC_UPDATING' ) ) {
		return $value;
	}
	return 'disabled' === get_option( 'poocommerce_ship_to_countries' ) ? 'no' : 'yes';
}
add_filter( 'pre_option_poocommerce_calc_shipping', 'poocommerce_calc_shipping_backwards_compatibility' );
 ...
 * @return string
 */
function poocommerce_get_product_schema() {
	wc_deprecated_function( 'poocommerce_get_product_schema', '3.0' );
...
/**
 * PooCommerce Core Supported Themes.
 *
 * @deprecated 3.3.0
 * @since 2.2
 * @return string[]
...
function wc_get_min_max_price_meta_query( $args ) {
	...
	return apply_filters(
		'poocommerce_get_min_max_price_meta_query',
		array(
			'key'     => '_price',
 ...
 * @return bool
 */
function update_poocommerce_term_meta( $term_id, $meta_key, $meta_value, $prev_value = '' ) {
	wc_deprecated_function( 'update_poocommerce_term_meta', '3.6', 'update_term_meta' );
	return function_exists( 'update_term_meta' ) ? update_term_meta( $term_id, $meta_key, $meta_value, $prev_value ) : update_metadata( 'poocommerce_term', $term_id, $meta_key, $meta_value, $prev_value );
}
 ...
 * @return bool
 */
function add_poocommerce_term_meta( $term_id, $meta_key, $meta_value, $unique = false ) {
	wc_deprecated_function( 'add_poocommerce_term_meta', '3.6', 'add_term_meta' );
	return function_exists( 'add_term_meta' ) ? add_term_meta( $term_id, $meta_key, $meta_value, $unique ) : add_metadata( 'poocommerce_term', $term_id, $meta_key, $meta_value, $unique );
}
 ...
 * @return bool
 */
function delete_poocommerce_term_meta( $term_id, $meta_key, $meta_value = '', $deprecated = false ) {
	wc_deprecated_function( 'delete_poocommerce_term_meta', '3.6', 'delete_term_meta' );
	return function_exists( 'delete_term_meta' ) ? delete_term_meta( $term_id, $meta_key, $meta_value ) : delete_metadata( 'poocommerce_term', $term_id, $meta_key, $meta_value );
}
 ...
 * @return mixed
 */
function get_poocommerce_term_meta( $term_id, $key, $single = true ) {
	wc_deprecated_function( 'get_poocommerce_term_meta', '3.6', 'get_term_meta' );
	return function_exists( 'get_term_meta' ) ? get_term_meta( $term_id, $key, $single ) : get_metadata( 'poocommerce_term', $term_id, $key, $single );
}
