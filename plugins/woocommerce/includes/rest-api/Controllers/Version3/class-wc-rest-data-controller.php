...
class WC_REST_Data_Controller extends WC_REST_Controller {
	...
	public function get_items( $request ) {
		...
		$resources = array(
			array(
				'slug'        => 'continents',
				'description' => __( 'List of supported continents, countries, and states.', 'poocommerce' ),
			),
			array(
				'slug'        => 'countries',
				'description' => __( 'List of supported states in a given country.', 'poocommerce' ),
			),
			array(
				'slug'        => 'currencies',
				'description' => __( 'List of supported currencies.', 'poocommerce' ),
			),
		);
	...
	public function get_item_schema() {
		$schema = array(
			...
			'properties' => array(
				'slug'        => array(
					'description' => __( 'Data resource ID.', 'poocommerce' ),
					'type'        => 'string',
					'context'     => array( 'view' ),
					'readonly'    => true,
				),
				'description' => array(
					'description' => __( 'Data resource description.', 'poocommerce' ),
					'type'        => 'string',
					'context'     => array( 'view' ),
					'readonly'    => true,
				),
