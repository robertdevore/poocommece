...
class WC_REST_Order_Notes_Controller extends WC_REST_Order_Notes_V2_Controller {
	...
	public function prepare_item_for_response( $note, $request ) {
		$data = array(
			...
			'author'           => __( 'poocommerce', 'poocommerce' ) === $note->comment_author ? 'system' : $note->comment_author,
	...
	public function get_item_schema() {
		$schema = array(
			...
			'properties' => array(
				...
				'added_by_user'    => array(
					'description' => __( 'If true, this note will be attributed to the current user. If false, the note will be attributed to the system.', 'poocommerce' ),
					'type'        => 'boolean',
					'default'     => false,
					'context'     => array( 'edit' ),
				),
