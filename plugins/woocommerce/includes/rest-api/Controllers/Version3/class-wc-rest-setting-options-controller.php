...
class WC_REST_Setting_Options_Controller extends WC_REST_Setting_Options_V2_Controller {
	...
	public function get_group_settings( $group_id ) {
		...
		$settings = apply_filters( 'poocommerce_settings-' . $group_id, array() ); // phpcs:ignore WordPress.NamingConventions.ValidHookName.UseUnderscores
	...
	public function get_item_schema() {
		$schema = array(
			...
			'properties' => array(
				...
				'group_id'    => array(
					'description' => __( 'An identifier for the group this setting belongs to.', 'poocommerce' ),
					'type'        => 'string',
					'arg_options' => array(
						'sanitize_callback' => 'sanitize_title',
					),
