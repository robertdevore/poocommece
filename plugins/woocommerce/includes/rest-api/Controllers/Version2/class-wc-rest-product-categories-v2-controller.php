	...
	public function get_item_schema() {
		$schema = array(
			...
			'properties' => array(
				...
				'parent'      => array(
					'description' => __( 'The ID for the parent of the resource.', 'poocommerce' ),
					'type'        => 'integer',
					'context'     => array( 'view', 'edit' ),
				),
				'description' => array(
				...
				'display'     => array(
					'description' => __( 'Category archive display type.', 'poocommerce' ),
					'type'        => 'string',
					'default'     => 'default',
				...
				'image'       => array(
					'description' => __( 'Image data.', 'poocommerce' ),
					'type'        => 'object',
					'context'     => array( 'view', 'edit' ),
					'properties'  => array(
						'id'                => array(
