...
final class PooCommerce {
	...
	private function init_hooks() {
		...
		Automattic\PooCommerce\Internal\Admin\WcPayWelcomePage::instance()->register();
	...
	public function load_plugin_textdomain() {
		 ...
		 */
		$locale = apply_filters( 'plugin_locale', $locale, 'poocommerce' ); // phpcs:ignore PooCommerce.Commenting.CommentHooks.MissingSinceComment

		unload_textdomain( 'poocommerce', true );
		load_textdomain( 'poocommerce', WP_LANG_DIR . '/poocommerce/poocommerce-' . $locale . '.mo' );
		load_plugin_textdomain( 'poocommerce', false, plugin_basename( dirname( WC_PLUGIN_FILE ) ) . '/i18n/languages' );
	}
