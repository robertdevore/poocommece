...
if ( ! function_exists( 'is_cart' ) ) {
	...
	function is_cart() {
		 ...
		 */
		return apply_filters( 'poocommerce_is_cart', false ) || Constants::is_defined( 'WOOCOMMERCE_CART' ) || CartCheckoutUtils::is_cart_page();
	}
}
...
if ( ! function_exists( 'is_checkout' ) ) {
	...
	function is_checkout() {
		 ...
		 */
		return apply_filters( 'poocommerce_is_checkout', false ) || Constants::is_defined( 'WOOCOMMERCE_CHECKOUT' ) || CartCheckoutUtils::is_checkout_page();
	}
}
