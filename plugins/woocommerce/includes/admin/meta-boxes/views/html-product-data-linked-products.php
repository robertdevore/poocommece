...
<div id="linked_product_data" class="panel poocommerce_options_panel hidden">
	...
	<div class="options_group show_if_grouped">
		<p class="form-field">
			...
			<select class="wc-product-search" multiple="multiple" style="width: 50%;" id="grouped_products" name="grouped_products[]" data-sortable="true" data-placeholder="<?php esc_attr_e( 'Search for a product&hellip;', 'poocommerce' ); ?>" data-action="poocommerce_json_search_products" data-exclude="<?php echo intval( $post->ID ); ?>">
				<?php
	...
	<div class="options_group">
		<p class="form-field">
			...
			<select class="wc-product-search" multiple="multiple" style="width: 50%;" id="upsell_ids" name="upsell_ids[]" data-placeholder="<?php esc_attr_e( 'Search for a product&hellip;', 'poocommerce' ); ?>" data-action="poocommerce_json_search_products_and_variations" data-exclude="<?php echo intval( $post->ID ); ?>">
				<?php
		...
		<p class="form-field hide_if_grouped hide_if_external">
			...
			<select class="wc-product-search" multiple="multiple" style="width: 50%;" id="crosssell_ids" name="crosssell_ids[]" data-placeholder="<?php esc_attr_e( 'Search for a product&hellip;', 'poocommerce' ); ?>" data-action="poocommerce_json_search_products_and_variations" data-exclude="<?php echo intval( $post->ID ); ?>">
				<?php
