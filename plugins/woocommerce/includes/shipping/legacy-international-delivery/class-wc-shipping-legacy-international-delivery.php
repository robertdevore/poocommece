...
class WC_Shipping_Legacy_International_Delivery extends WC_Shipping_Legacy_Flat_Rate {
	...
	public function __construct() {
		...
		$this->method_title = __( 'International flat rate (legacy)', 'poocommerce' );
	...
	public function init_form_fields() {
		...
		$this->form_fields['availability'] = array(
			...
			'default'     => 'including',
			'options'     => array(
				'including' => __( 'Selected countries', 'poocommerce' ),
				'excluding' => __( 'Excluding selected countries', 'poocommerce' ),
			),
		);
	}
	...
	public function is_available( $package ) {
		...
		return apply_filters( 'poocommerce_shipping_' . $this->id . '_is_available', true, $package, $this );
	}
}
