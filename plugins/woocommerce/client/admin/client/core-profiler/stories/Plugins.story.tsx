...
const plugins = [
	{
		...
		image_url:
			'https://poocommerce.com/wp-content/plugins/wccom-plugins/obw-free-extensions/images/core-profiler/logo-jetpack.svg',
	...
	},
	{
		...
		image_url:
			'https://poocommerce.com/wp-content/plugins/wccom-plugins/obw-free-extensions/images/core-profiler/logo-pinterest.svg',
		...
		learn_more_link:
			'https://poocommerce.com/products/pinterest-for-poocommerce',
		install_priority: 2,
		is_visible: true,
		is_installed: false,
		is_activated: false,
...
export const InstallationErrorBanner = () => (
	<div className="poocommerce-profiler-plugins">
		<PluginErrorBanner
...
export default {
	title: 'PooCommerce Admin/Core Profiler/Plugins',
	component: Plugins,
