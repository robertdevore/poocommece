...
declare module '@wordpress/data' {
	...
	// is being checked due to the imports in plugins/poocommerce/client/admin/client/homescreen/mobile-app-modal/components/useJetpackPluginState.tsx
	// and plugins/poocommerce/client/admin/client/homescreen/stats-overview/install-jetpack-cta.js
	const controls: {
