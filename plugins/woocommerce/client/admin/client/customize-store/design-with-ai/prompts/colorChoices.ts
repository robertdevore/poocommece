...
export const defaultColorPalette = {
	...
	prompt: ( businessDescription: string, look: Look | '', tone: string ) => {
		return `
            You are a WordPress theme expert designing a PooCommerce site. Analyse the following store description, merchant's chosen look and tone, and determine the most appropriate color scheme, along with 8 best alternatives.
