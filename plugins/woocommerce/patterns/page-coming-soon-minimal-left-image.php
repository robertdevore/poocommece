 ...
 * Slug: poocommerce/page-coming-soon-minimal-left-image
...
$store_description = ! empty( $site_tagline )
	...
	: sprintf(
		...
		__( '%s transforms your home with our curated collection of home decor, bringing inspiration and style to every corner.', 'poocommerce' ),
		get_bloginfo( 'name' )
	);

?>
<!-- wp:poocommerce/coming-soon {"comingSoonPatternId":"page-coming-soon-minimal-left-image","className":"poocommerce-coming-soon-entire-site poocommerce-coming-soon-minimal-left-image","style":{"color":{"background":"#f9f9f9"}}} -->
<div class="wp-block-poocommerce-coming-soon poocommerce-coming-soon-entire-site poocommerce-coming-soon-minimal-left-image has-background" style="background-color:#f9f9f9"><!-- wp:cover {"minHeight":100,"minHeightUnit":"vh","isDark":false,"className":"coming-soon-is-vertically-aligned-center coming-soon-cover","layout":{"type":"default"}} -->
	<div class="wp-block-cover is-light coming-soon-is-vertically-aligned-center coming-soon-cover" style="min-height:100vh"><span aria-hidden="true" class="wp-block-cover__background has-background-dim-100 has-background-dim"></span><div class="wp-block-cover__inner-container"><!-- wp:group {"align":"wide","className":"poocommerce-coming-soon-header has-background","style":{"spacing":{"padding":{"top":"10px","bottom":"14px"}}},"layout":{"type":"constrained"}} -->
		<div class="wp-block-group alignwide poocommerce-coming-soon-header has-background" style="padding-top:10px;padding-bottom:14px"><!-- wp:group {"align":"wide","layout":{"type":"flex","justifyContent":"space-between","flexWrap":"wrap"}} -->
		...
		<!-- wp:group {"align":"full","className":"poocommerce-coming-soon-minimal-left-image__content","style":{"spacing":{"padding":{"top":"0","bottom":"0"},"margin":{"top":"120px","bottom":"120px"}}},"layout":{"type":"default"}} -->
		<div class="wp-block-group alignfull poocommerce-coming-soon-minimal-left-image__content" style="margin-top:120px;margin-bottom:120px;padding-top:0;padding-bottom:0"><!-- wp:group {"layout":{"type":"constrained"}} -->
			<div class="wp-block-group"><!-- wp:columns {"className":"alignfull","style":{"spacing":{"padding":{"top":"0","bottom":"0","left":"0","right":"0"},"blockGap":{"top":"0","left":"60px"},"margin":{"top":"0px","bottom":"0px"}},"layout":{"selfStretch":"fit","flexSize":null}}} -->
				<div class="wp-block-columns alignfull" style="margin-top:0px;margin-bottom:0px;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><!-- wp:column {"verticalAlignment":"bottom","width":"481px","className":"poocommerce-coming-soon-minimal-left-image__content-image","layout":{"type":"default"}} -->
					<div class="wp-block-column is-vertically-aligned-bottom poocommerce-coming-soon-minimal-left-image__content-image" style="flex-basis:481px"><!-- wp:image {"scale":"cover","style":{"border":{"radius":"16px"}}} -->
					...
					<!-- wp:column {"verticalAlignment":"stretch","width":"453px","className":"poocommerce-coming-soon-minimal-left-image__content-text","style":{"spacing":{"blockGap":"0","padding":{"right":"0","left":"0","bottom":"0","top":"53px"}}},"layout":{"type":"default"}} -->
					<div class="wp-block-column is-vertically-aligned-stretch poocommerce-coming-soon-minimal-left-image__content-text" style="padding-top:53px;padding-right:0;padding-bottom:0;padding-left:0;flex-basis:453px"><!-- wp:group {"style":{"dimensions":{"minHeight":"100%"},"spacing":{"blockGap":"0"}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"stretch","flexWrap":"nowrap","verticalAlignment":"space-between"}} -->
						<div class="wp-block-group" style="min-height:100%"><!-- wp:heading {"className":"is-style-default","style":{"elements":{"link":{"color":{"text":"#000"}}},"color":{"text":"#000"},"typography":{"fontSize":"38px","lineHeight":"1.19"},"spacing":{"margin":{"bottom":"var:preset|spacing|30"}}},"fontFamily":"heading"} -->
							<h2 class="wp-block-heading is-style-default has-text-color has-link-color has-heading-font-family" style="color:#000;margin-bottom:var(--wp--preset--spacing--30);font-size:38px;line-height:1.19"><?php echo esc_html__( 'Something big is brewing! Our store is in the works – Launching shortly!', 'poocommerce' ); ?></h2>
							<!-- /wp:heading -->
