...
?>
<!-- wp:poocommerce/coming-soon {"comingSoonPatternId":"page-coming-soon-split-right-image","className":"poocommerce-coming-soon-split-right-image","style":{"color":{"background":"#f9f9f9"}}} -->
<div class="wp-block-poocommerce-coming-soon poocommerce-coming-soon-split-right-image has-background" style="background-color:#f9f9f9">
		...
		<div class="wp-block-columns poocommerce-split-right-image-content" style="margin-top:0px;margin-bottom:0px"><!-- wp:column {"verticalAlignment":"center","layout":{"type":"default"}} -->
			<div class="wp-block-column is-vertically-aligned-center"><!-- wp:group {"layout":{"type":"constrained","contentSize":"259px"}} -->
				<div class="wp-block-group"><!-- wp:heading {"textAlign":"center","level":1,"style":{"typography":{"fontSize":"14px","letterSpacing":"2.1px","fontStyle":"normal","fontWeight":"700","textTransform":"uppercase"}},"fontFamily":"<?php echo esc_attr( $inter_font_family ); ?>"} -->
					<h1 class="wp-block-heading has-text-align-center has-<?php echo esc_attr( $inter_font_family ); ?>-font-family" style="font-size:14px;font-style:normal;font-weight:700;letter-spacing:2.1px;text-transform:uppercase"><?php echo esc_html_x( 'opening soon', 'Used in the heading of the coming soon page', 'poocommerce' ); ?></h1>
					<!-- /wp:heading -->
