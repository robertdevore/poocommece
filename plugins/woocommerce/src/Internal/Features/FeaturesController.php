...
class FeaturesController {
	 ...
	 * Register a feature.
	 *
	 * This should be called during the `poocommerce_register_feature_definitions` action hook.
	 *
			...
			$legacy_features                  = array(
				...
				'rate_limit_checkout'    => array(
					...
					'description'        => sprintf(
						...
						'https://github.com/poocommerce/poocommerce/blob/trunk/plugins/poocommerce/src/StoreApi/docs/rate-limiting.md'
					),
					'is_experimental'    => false,
					'disable_ui'         => false,
					'enabled_by_default' => false,
				...
				'remote_logging'         => array(
					...
					'description'        => __(
						'Enable this feature to log errors and related data to Automattic servers for debugging purposes and to improve PooCommerce',
						'poocommerce'
					),
					'enabled_by_default' => true,
					'disable_ui'         => false,
