...
class BrandingController {
	 ...
	 * @return string
	 */
	public static function get_default_email_base_color() {
		return self::use_new_branding() ? '#720eec' : '#7f54b3';
	}
	 ...
	 * @return string
	 */
	public static function get_dashboard_menu_icon_base64() {
		return self::use_new_branding() ?
