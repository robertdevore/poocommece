...
class ComingSoonCacheInvalidator {
	...
	final public function init() {
		add_action( 'update_option_poocommerce_coming_soon', array( $this, 'invalidate_caches' ) );
		add_action( 'update_option_poocommerce_store_pages_only', array( $this, 'invalidate_caches' ) );
	}
	...
	public function invalidate_caches() {
		 ...
		 */
		$cart_page_id = get_option( 'poocommerce_cart_page_id' ) ?? null;
		if ( $cart_page_id ) {
