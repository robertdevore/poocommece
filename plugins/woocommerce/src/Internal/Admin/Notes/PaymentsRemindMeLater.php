...
class PaymentsRemindMeLater {
	...
	public static function get_note() {
		...
		$content = __( 'Save up to $800 in fees by managing transactions with WooPayments. With WooPayments, you can securely accept major cards, Apple Pay, and payments in over 100 currencies.', 'poocommerce' );

		$note = new Note();
		$note->set_title( __( 'Save big with WooPayments', 'poocommerce' ) );
