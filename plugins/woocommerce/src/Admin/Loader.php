 ...
 * Loader Class.
 *
 * @deprecated since 6.3.0, use PooCommerce\Internal\Admin\Loader.
 */
class Loader extends DeprecatedClassFacade {
	 ...
	 * @var string
	 */
	protected static $facade_over_classname = 'Automattic\PooCommerce\Internal\Admin\Loader';
	...
	public static function is_feature_enabled( $feature ) {
		wc_deprecated_function( 'is_feature_enabled', '5.0', '\Automattic\PooCommerce\Internal\Features\Features::is_enabled()' );
	...
	public static function is_admin_or_embed_page() {
		wc_deprecated_function( 'is_admin_or_embed_page', '6.3', '\Automattic\PooCommerce\Admin\PageController::is_admin_or_embed_page()' );
	...
	public static function is_admin_page() {
		wc_deprecated_function( 'is_admin_page', '6.3', '\Automattic\PooCommerce\Admin\PageController::is_admin_page()' );
	...
	public static function is_embed_page() {
		wc_deprecated_function( 'is_embed_page', '6.3', '\Automattic\PooCommerce\Admin\PageController::is_embed_page()' );
