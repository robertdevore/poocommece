...
class DeprecatedOptions {
	...
	public static function init() {
		...
		add_action( 'pre_update_option_poocommerce_task_list_hidden', array( __CLASS__, 'update_deprecated_options' ), 10, 3 );
		add_action( 'pre_update_option_poocommerce_extended_task_list_hidden', array( __CLASS__, 'update_deprecated_options' ), 10, 3 );
	}
