 ...
 *         );
 * $report = new \Automattic\PooCommerce\Admin\API\Reports\Taxes\Stats\Query( $args );
...
class Query extends ReportsQuery {
	...
	public function get_data() {
		...
		$args = apply_filters( 'poocommerce_analytics_taxes_stats_query_args', $this->get_query_vars() );

		$data_store = \WC_Data_Store::load( 'report-taxes-stats' );
		$results    = $data_store->get_data( $args );
		return apply_filters( 'poocommerce_analytics_taxes_stats_select_query', $results, $args );
	}
}
