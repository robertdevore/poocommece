 ...
 *         );
 * $report = new \Automattic\PooCommerce\Admin\API\Reports\Variations\Query( $args );
...
class Query extends ReportsQuery {
	...
	public function get_data() {
		...
		$args = apply_filters( 'poocommerce_analytics_variations_query_args', $this->get_query_vars() );

		$data_store = \WC_Data_Store::load( 'report-variations' );
		$results    = $data_store->get_data( $args );
		return apply_filters( 'poocommerce_analytics_variations_select_query', $results, $args );
	}
}
