...
class CheckoutFields {
	...
	public function validate_field( $field_key, $field_value ) {
		...
		try {
			 ...
			 *
			 * @since 8.6.0
			 * @deprecated 8.7.0 Use poocommerce_validate_additional_field instead.
			 */
	...
	public function validate_fields_for_location( $fields, $location, $group = 'other' ) {
		...
		try {
			 ...
			 *
			 * @since 8.6.0
			 * @deprecated 8.9.0 Use poocommerce_blocks_validate_location_order_fields instead.
			 */
			wc_do_deprecated_action( 'poocommerce_blocks_validate_location_additional_fields', array( $errors, $fields, $group ), '8.9.0', 'poocommerce_blocks_validate_location_additional_fields', 'This action has been graduated, use poocommerce_blocks_validate_location_additional_fields instead.' );
			/**
			 * Pass an error object to allow validation of an additional field.
			 *
			 * @param WP_Error $errors  A WP_Error object that extensions may add errors to.
			 ...
			 *
			 * @since 8.6.0
			 * @deprecated 8.9.0 Use poocommerce_blocks_validate_location_{location}_fields instead.
			 */
