 ...
 *
 * This template can be overridden by copying it to yourtheme/poocommerce/brands/widgets/brand-thumbnails-description.php.
 *
...
<ul class="brand-thumbnails-description">
	...
	foreach ( $brands as $index => $brand ) :
		 ...
		 */
		$thumbnail = wc_get_brand_thumbnail_url( $brand->term_id, apply_filters( 'poocommerce_brand_thumbnail_size', 'shop_catalog' ) );
