 ...
 *
 * This template can be overridden by copying it to yourtheme/poocommerce/emails/admin-new-order.php.
 *
...
<p><?php printf( esc_html__( 'You’ve received the following order from %s:', 'poocommerce' ), $order->get_formatted_billing_full_name() ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></p>
<?php
