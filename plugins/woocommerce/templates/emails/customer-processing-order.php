 ...
 *
 * This template can be overridden by copying it to yourtheme/poocommerce/emails/customer-processing-order.php.
 *
...
<p><?php printf( esc_html__( 'Just to let you know &mdash; we\'ve received your order #%s, and it is now being processed:', 'poocommerce' ), esc_html( $order->get_order_number() ) ); ?></p>
