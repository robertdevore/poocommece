 ...
 *
 * This template can be overridden by copying it to yourtheme/poocommerce/emails/plain/customer-reset-password.php.
 *
...
echo sprintf( esc_html__( 'Someone has requested a new password for the following account on %s:', 'poocommerce' ), esc_html( wp_specialchars_decode( get_option( 'blogname' ), ENT_QUOTES ) ) ) . "\n\n";
/* translators: %s: Customer username */
echo sprintf( esc_html__( 'Username: %s', 'poocommerce' ), esc_html( $user_login ) ) . "\n\n";
echo esc_html__( 'If you didn\'t make this request, just ignore this email. If you\'d like to proceed:', 'poocommerce' ) . "\n\n";
