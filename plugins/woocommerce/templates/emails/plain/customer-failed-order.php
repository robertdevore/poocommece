 ...
 *
 * This template can be overridden by copying it to yourtheme/poocommerce/emails/plain/customer-failed-order.php.
 *
...
echo esc_html__( "Unfortunately, we couldn't complete your order due to an issue with your payment method.", 'poocommerce' ) . "\n\n";
/* translators: %s: Site title */
echo sprintf( esc_html__( "If you'd like to continue with your purchase, please return to %s and try a different method of payment.", 'poocommerce' ), esc_html( wp_specialchars_decode( get_option( 'blogname' ), ENT_QUOTES ) ) ) . "\n\n";
echo esc_html__( 'Your order details are as follows:', 'poocommerce' ) . "\n\n";
