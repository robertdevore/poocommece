 ...
 *
 * This template can be overridden by copying it to yourtheme/poocommerce/emails/plain/email-customer-details.php.
 *
...
echo esc_html( wc_strtoupper( esc_html__( 'Customer details', 'poocommerce' ) ) ) . "\n\n";
