 ...
 *
 * This template can be overridden by copying it to yourtheme/poocommerce/emails/plain/customer-on-hold-order.php.
 *
...
echo esc_html__( 'Thanks for your order. It’s on-hold until we confirm that payment has been received.', 'poocommerce' ) . "\n\n";
