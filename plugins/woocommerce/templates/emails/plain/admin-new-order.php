 ...
 *
 * This template can be overridden by copying it to yourtheme/poocommerce/emails/plain/admin-new-order.php.
 *
...
echo sprintf( esc_html__( 'You’ve received the following order from %s:', 'poocommerce' ), esc_html( $order->get_formatted_billing_full_name() ) ) . "\n\n";
