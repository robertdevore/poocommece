 ...
 *
 * This template can be overridden by copying it to yourtheme/poocommerce/emails/plain/customer-refunded-order.php.
 *
...
if ( $partial_refund ) {
	...
	echo sprintf( esc_html__( 'Your order on %s has been partially refunded. There are more details below for your reference:', 'poocommerce' ), wp_specialchars_decode( get_option( 'blogname' ), ENT_QUOTES ) ) . "\n\n"; // phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped
} else {
	/* translators: %s: Site title */
	echo sprintf( esc_html__( 'Your order on %s has been refunded. There are more details below for your reference:', 'poocommerce' ), wp_specialchars_decode( get_option( 'blogname' ), ENT_QUOTES ) ) . "\n\n"; // phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped
}
