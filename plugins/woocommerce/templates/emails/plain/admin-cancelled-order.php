 ...
 *
 * This template can be overridden by copying it to yourtheme/poocommerce/emails/plain/admin-cancelled-order.php.
 *
...
echo sprintf( esc_html__( 'Notification to let you know &mdash; order #%1$s belonging to %2$s has been cancelled:', 'poocommerce' ), esc_html( $order->get_order_number() ), esc_html( $order->get_formatted_billing_full_name() ) ) . "\n\n";
