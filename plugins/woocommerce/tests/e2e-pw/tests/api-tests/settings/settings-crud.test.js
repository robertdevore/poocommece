				...
				expect( responseJSON ).toEqual(
					expect.arrayContaining( [
						expect.objectContaining( {
							...
							type: 'textarea',
							default:
								'Hopefully they’ll be back. Read more about <a href="https://poocommerce.com/document/managing-orders/">troubleshooting failed payments</a>.',
							tip: 'Text to appear below the main email content. Available placeholders: <code>{site_title}&lt;/code&gt;, &lt;code&gt;{site_address}&lt;/code&gt;, &lt;code&gt;{site_url}&lt;/code&gt;, &lt;code&gt;{order_date}&lt;/code&gt;, &lt;code&gt;{order_number}</code>',
							value: 'Hopefully they’ll be back. Read more about <a href="https://poocommerce.com/document/managing-orders/">troubleshooting failed payments</a>.',
						} ),
					] )
				);
				expect( responseJSON ).toEqual(
