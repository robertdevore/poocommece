...
class WC_Helper_Fee {
	...
	public static function add_cart_fee( $fee = '' ) {
		switch ( $fee ) {
			case 'taxed':
				add_action( 'poocommerce_cart_calculate_fees', array( __CLASS__, 'create_taxed_fee' ) );
				break;
			case 'negative':
				add_action( 'poocommerce_cart_calculate_fees', array( __CLASS__, 'create_negative_fee' ) );
				break;
			case 'negative-taxed':
				add_action( 'poocommerce_cart_calculate_fees', array( __CLASS__, 'create_negative_taxed_fee' ) );
				break;
			default:
				add_action( 'poocommerce_cart_calculate_fees', array( __CLASS__, 'create_simple_fee' ) );
		}
	}
	...
	public static function remove_cart_fee( $fee = '' ) {
		switch ( $fee ) {
			case 'taxed':
				remove_action( 'poocommerce_cart_calculate_fees', array( __CLASS__, 'create_taxed_fee' ) );
				break;
			case 'negative':
				remove_action( 'poocommerce_cart_calculate_fees', array( __CLASS__, 'create_negative_fee' ) );
				break;
			case 'negative-taxed':
				remove_action( 'poocommerce_cart_calculate_fees', array( __CLASS__, 'create_negative_taxed_fee' ) );
				break;
			default:
				remove_action( 'poocommerce_cart_calculate_fees', array( __CLASS__, 'create_simple_fee' ) );
		}
	}
}
