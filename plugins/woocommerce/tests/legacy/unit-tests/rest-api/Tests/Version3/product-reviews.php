...
class WC_Tests_API_Product_Reviews extends WC_REST_Unit_Test_Case {
	...
	public function test_get_product_reviews() {
		...
		for ( $i = 0; $i < 10; $i++ ) {
			$review_id = \Automattic\PooCommerce\RestApi\UnitTests\Helpers\ProductHelper::create_product_review( $product->get_id() );
		}
	...
	public function test_get_product_review() {
		wp_set_current_user( $this->user );
		$product           = \Automattic\PooCommerce\RestApi\UnitTests\Helpers\ProductHelper::create_simple_product();
		$product_review_id = \Automattic\PooCommerce\RestApi\UnitTests\Helpers\ProductHelper::create_product_review( $product->get_id() );
	...
	public function test_product_reviews_batch() {
		...
		$review_1_id = \Automattic\PooCommerce\RestApi\UnitTests\Helpers\ProductHelper::create_product_review( $product->get_id() );
		$review_2_id = \Automattic\PooCommerce\RestApi\UnitTests\Helpers\ProductHelper::create_product_review( $product->get_id() );
		$review_3_id = \Automattic\PooCommerce\RestApi\UnitTests\Helpers\ProductHelper::create_product_review( $product->get_id() );
		$review_4_id = \Automattic\PooCommerce\RestApi\UnitTests\Helpers\ProductHelper::create_product_review( $product->get_id() );
