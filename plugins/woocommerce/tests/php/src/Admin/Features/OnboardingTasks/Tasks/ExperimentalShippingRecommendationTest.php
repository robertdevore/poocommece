...
class ExperimentalShippingRecommendationTest extends WC_Unit_Test_Case {
	...
	/**
	 * Tests that if the PooCommerce Shipping extension is enabled, the task is unavailable.
	 *
	 * @return void
	 */
	public function test_can_view_returns_false_if_poocommerce_shipping_is_active() {
		$this->enabled_admin_features_mock = array( 'shipping-smart-defaults' );
		$this->mock_active_plugin_basenames(
			array(
				'poocommerce-shipping/poocommerce-shipping.php',
			)
		);
	...
	/**
	 * Tests that if the PooCommerce Tax extension is enabled, the task is unavailable.
	 *
	 * @return void
	 */
	public function test_can_view_returns_false_if_poocommerce_tax_is_active() {
		$this->enabled_admin_features_mock = array( 'shipping-smart-defaults' );
		$this->mock_active_plugin_basenames(
			array(
				'poocommerce-tax/poocommerce-tax.php',
			)
		);
	...
	/**
	 * Tests that if the PooCommerce Shipping and PooCommerce Tax extensions are enabled, the task is unavailable.
	 *
	 * @return void
	 */
