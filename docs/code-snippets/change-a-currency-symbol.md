...
See the [currency list](https://poocommerce.github.io/code-reference/files/poocommerce-includes-wc-core-functions.html#source-view.475) for reference on currency codes.
