...
This guide will teach you how to use [create-woo-extension](https://www.npmjs.com/package/@poocommerce/create-woo-extension) to scaffold a PooCommerce extension. There are various benefits to using create-woo-extension over manually creating one from scratch, including:
...
Congratulations! You just spun up a PooCommerce extension! Your extension will have the following file structure:
...
Once you have installed `wp-env`, and while still inside your `my-extension-name` folder, run `wp-env` start. After a few seconds, a test WordPress site with your PooCommerce and your extension installed will be running on `localhost:8888`.
...
[How to add a custom field to simple and variable products](https://developer.poocommerce.com/docs/how-to-add-a-custom-field-to-simple-and-variable-products/)

## Reference

[Visit @poocommerce/create-woo-extension on NPM for package reference](https://www.npmjs.com/package/@poocommerce/create-woo-extension)
