---
post_title: PooCommerce Extension Guidelines - Task List and Inbox
...
Use the Task List and Inbox sparingly. Messages should be clear, concise, and maintain a consistent tone. Follow the [Grammar, Punctuation, and Capitalization guide](https://poocommerce.com/document/grammar-punctuation-style-guide/).

## Task List

![an example of a task in the task list](https://developer.poocommerce.com/wp-content/uploads/2023/12/task-list1.png)
...
![three tasks in the task list under the heading "Things to do next" with the option to expand at the bottom to "show 3 more tasks" ](https://developer.poocommerce.com/wp-content/uploads/2023/12/task-list-example.png)
...
![an example of an inbox notification](https://developer.poocommerce.com/wp-content/uploads/2023/12/inbox1.png)
...
![an example of two inbox notifications listed under the "Inbox" section of the admin](https://developer.poocommerce.com/wp-content/uploads/2023/12/inbox-examples.png)
